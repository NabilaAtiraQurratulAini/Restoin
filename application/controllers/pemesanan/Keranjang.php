...
class Keranjang extends CI_Controller
{
    ...
    public function checkout()
    {
        ...
        $foto_file = $_FILES['foto_file'];
            ...
            if ($metode !== 'Tunai' && !empty($tmp)) {
                $foto_file = $id . '_' . date('Y-m-d') . '_' . $_FILES['foto_file']['name'];
                move_uploaded_file($tmp, './assets/img/upload/bukti/' . $foto_file);
            } else {
