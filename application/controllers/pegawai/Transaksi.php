...
class Transaksi extends CI_Controller
{
    ...
    public function detail($id)
    {
        ...
        if ($data['transaksi']) {
            ...
            if (isset($data['transaksi']->bukti_pembayaran)) {
                $bukti_pembayaran = $data['transaksi']->bukti_pembayaran;
            } else {
                $bukti_pembayaran = 'default.jpg'; // Gambar default jika tidak ada bukti pembayaran
            }
            $data['item'] = $this->model_admin->get('item_penjualan', $where);
    
            // Kirim bukti_pembayaran ke view
            ...
            redirect('pegawai/transaksi'); // Redirect pengguna kembali ke halaman transaksi
        }
    }    
